 ...
 * NEXT_PUBLIC_TREASURY_ADDRESS=<the public key>
 */

import { generateKeyPairSigner, createSignerFromKeyPair } from '@metaplex-foundation/umi';
...
async function main() {
    ...
    const secretKeyBase58 = base58.deserialize(keypair.secretKey)[0];
    ...
    console.log(`NEXT_PUBLIC_TREASURY_ADDRESS=${publicKey}`);
